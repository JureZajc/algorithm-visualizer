...
ALGORITHM_PSEUDOCODE = {
    ...
    "avl_insert": [
        ...
        "insert the value using normal BST ordering",
        "walk back toward the root and update height",
        "compute the balance factor at each ancestor",
        "if balance is outside -1..1, identify the rotation case",
        "rotate left for a right-right imbalance",
        "rotate right for a left-left imbalance",
        "rotate left then right for a left-right imbalance",
        "rotate right then left for a right-left imbalance",
        "finish with the balanced AVL tree",
    ],
    "bst_search": [
...
TREES_ALGORITHM_METADATA = [
    ...
    metadata(
        ...
        "AVL Tree Insert",
        "trees",
        "Builds a self-balancing binary search tree by updating heights and rotating after insertions.",
        "O(log n)",
        "O(log n)",
        "O(log n)",
        "O(n)",
        "Input values must be unique in this version.",
        "Balance factor is left subtree height minus right subtree height.",
        "Rotations preserve BST order while keeping every balance factor between -1 and 1.",
    ),
    metadata(
        "bst_search",
        "BST Search",
